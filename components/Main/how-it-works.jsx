...
const steps = [
    {
        ...
        description: "Décrivez votre besoin en quelques secondes : le type de service, votre adresse à Casablanca et vos préférences.",
        Illustration: PhoneIllustration,
    },
    {
        number: 2,
        title: "Comparez les réponses vérifiées",
        description: "Recevez des propositions d'artisans vérifiés, avec avis liés à des travaux réalisés et possibilité de facture.",
        Illustration: ReviewsIllustration,
    },
    {
        number: 3,
        title: "Choisissez en toute confiance",
        description: "Sélectionnez l'artisan qui vous convient. Contact direct, date d'intervention et travail en toute sérénité.",
