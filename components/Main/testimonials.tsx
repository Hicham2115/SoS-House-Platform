...
const testimonials = [
  {
    ...
    rating: "5.0",
    quote:
      "Le plombier est arrivé à l'heure, il a trouvé le problème rapidement et tout fonctionne parfaitement. J'ai demandé une facture et je l'ai reçue sans problème.",
    avatar: avatar1,
    DetailIcon: FileText,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Changement de disjoncteur et mise aux normes de mon tableau électrique. Travail propre, explications claires et facture avec TVA fournie.",
    avatar: avatar3,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Serrurier très pro et honnête. Il a changé la serrure de ma porte d'entrée en moins d'une heure. Je recommande les yeux fermés.",
    avatar: null,
    initials: "SH",
    DetailIcon: Key,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Très bonne expérience. L'artisan était ponctuel, professionnel et a laissé les lieux parfaitement propres après son intervention.",
    avatar: avatar3,
    DetailIcon: Wrench,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Intervention rapide et efficace pour réparer mon installation électrique. Le travail a été fait avec beaucoup de sérieux.",
    avatar: null,
    initials: "IR",
    DetailIcon: BadgeCheck,
  ...
  },
  {
    ...
    rating: "4.9",
    quote:
      "J'avais une fuite importante dans la salle de bain. Le problème a été identifié et réparé rapidement. Très satisfait du résultat.",
    avatar: avatar3,
    DetailIcon: Droplets,
    work: "Réparation fuite d'eau",
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Excellent service du début à la fin. Le serrurier est arrivé rapidement et a remplacé ma serrure sans aucun dégât.",
    avatar: null,
    initials: "SM",
    DetailIcon: Key,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Artisan sérieux et très professionnel. Il m'a bien expliqué les travaux à réaliser et le prix avant de commencer.",
    avatar: avatar3,
    DetailIcon: FileText,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Le travail est impeccable et l'intervention a été beaucoup plus rapide que prévu. Je referai appel à eux sans hésiter.",
    avatar: null,
    initials: "AL",
    DetailIcon: Wrench,
  ...
  },
  {
    ...
    rating: "5.0",
    quote:
      "Très satisfait de la prestation. Ponctuel, transparent sur les tarifs et surtout un travail de qualité. Je recommande vivement.",
    avatar: avatar3,
    DetailIcon: BadgeCheck,
  ...
  return (
    <div className="flex items-center gap-0.5">
      {Array.from({ length: 5 }, (_, i) => (
        <Star key={i} className="size-4 fill-[#ffc400] text-[#ffc400]" />
      ))}
    </div>
  );
}
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="relative mt-10 px-9 sm:px-0">
          <button
            ...
            className="absolute left-0 top-1/2 z-10 flex size-9 -translate-y-1/2 items-center justify-center rounded-full bg-white text-teal-700 shadow-[0_12px_28px_rgba(69,64,112,0.16)] transition hover:bg-teal-50 sm:size-11 sm:-translate-x-1/2"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 z-10 flex size-9 -translate-y-1/2 items-center justify-center rounded-full bg-white text-teal-700 shadow-[0_12px_28px_rgba(69,64,112,0.16)] transition hover:bg-teal-50 sm:size-11 sm:translate-x-1/2"
          >
          ...
          >
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="w-full shrink-0 snap-start rounded-2xl bg-white p-6 shadow-[0_12px_34px_rgba(69,64,112,0.08)] sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)]"
              >
                <div className="flex items-start gap-3">
                  <Avatar size="lg" className="size-14 shrink-0">
                    {t.avatar ? (
                      <AvatarImage src={t.avatar.src} alt="" />
                    ) : (
                      <AvatarFallback className="bg-teal-100 font-bold text-teal-800">
                        {t.initials}
                      </AvatarFallback>
                    )}
                  </Avatar>
                ...
                <div className="mt-4">
                  <Quote
                    className="size-6 fill-teal-100 text-teal-100"
                    strokeWidth={0}
                  />
        ...
        <p className="mt-6 flex items-center justify-center gap-2 text-center text-[13px] text-slate-500">
          <ShieldCheck
            ...
            strokeWidth={1.8}
          />
          Avis vérifiés et liés à des travaux réellement réalisés via SOS House.
        </p>
      </div>
    </section>
  );
