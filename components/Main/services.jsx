    ...
    return (<section id="services" className="relative isolate scroll-mt-20 overflow-hidden bg-[#f6f5fc] py-20 sm:py-24 lg:scroll-mt-24 lg:py-[86px]">
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6">
          {services.map((service) => (<div key={service.title} className="group w-full overflow-hidden rounded-2xl border border-slate-900/5 bg-white shadow-[0_12px_34px_rgba(69,64,112,0.08)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_20px_45px_rgba(69,64,112,0.16)] sm:w-[calc(50%-0.75rem)] lg:w-[calc(25%-1.125rem)]">
              <div className="relative h-[170px] w-full overflow-hidden">
                <Image src={service.image} alt={service.title} fill sizes="(min-width: 1024px) 25vw, (min-width: 640px) 50vw, 100vw" className="object-cover transition-transform duration-300 group-hover:scale-105"/>
