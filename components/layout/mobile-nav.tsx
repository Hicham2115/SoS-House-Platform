      ...
      <SheetContent side="right" className="w-full max-w-xs">
        ...
        <div className="mt-auto flex flex-col gap-3 border-t border-border p-4">
          <SheetClose
            ...
            nativeButton={false}
            className="rounded-lg px-3 py-2.5 text-center text-[15px] font-semibold text-teal-700"
          >
            Se connecter
          </SheetClose>
          <Button
            ...
            nativeButton={false}
            className="h-12 rounded-xl bg-[#ffc400] px-7 text-[15px] font-semibold text-slate-950 shadow-[0_8px_20px_rgba(255,196,0,0.18)] transition hover:bg-[#ffcb19]"
          >
            Publier une demande
          </Button>
        </div>
