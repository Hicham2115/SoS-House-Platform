            ...
            <ul className="space-y-3">
              {clientLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="flex items-center gap-1.5 text-sm text-slate-700 transition-colors hover:text-teal-700"
                  >
            ...
            <div className="mt-3 flex items-center gap-3">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="flex size-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-teal-700"
                >
