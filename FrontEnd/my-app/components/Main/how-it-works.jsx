...
const steps = [
    {
        ...
        description: "Décrivez votre besoin en quelques secondes : le type de service, votre adresse, l'urgence et si vous avez besoin d'une facture, simple ou avec TVA.",
        Illustration: PhoneIllustration,
    },
    {
        number: 2,
        title: "Comparez les réponses vérifiées",
        description: "Votre demande est envoyée aux prestataires vérifiés éligibles les plus proches et les mieux notés. Recevez leurs propositions, avec avis liés à des travaux réalisés.",
        Illustration: ReviewsIllustration,
    },
    {
        number: 3,
        title: "Choisissez en toute confiance",
        description: "Sélectionnez l'artisan qui vous convient. Une fois la mission terminée, vous confirmez chacun de votre côté avant que les avis ne soient publiés.",
        Illustration: DoorIllustration,
    },
];
function PhoneIllustration() {
    return (<svg viewBox="0 0 160 160" className="size-full">
      <circle cx="82" cy="86" r="60" fill="#eef1f6"/>
      <path d="M24 128c4-22 16-30 24-30 6 0 8 6 16 6s8-8 16-8 10 10 18 10 12-8 18-4" fill="none" stroke="#cfd6e2" strokeWidth="2" strokeLinecap="round"/>
      <path d="M24 132c0-18 8-28 12-28s6 10 12 10 6-6 10-6 10 8 10 22" fill="#a9d6c6"/>
      <rect x="20" y="118" width="16" height="18" rx="2" fill="#c9b79a"/>
      <g>
        <rect x="46" y="16" width="68" height="128" rx="16" fill="white" stroke="#0f7a75" strokeWidth="2.5"/>
        ...
        <g>
          ...
          <path d="M64 77.5c0-1.4 1.1-2.5 2.5-2.5s2.5 1.1 2.5 2.5c0 1.7-2.5 4-2.5 4s-2.5-2.3-2.5-4Z" fill="#0f7a75"/>
        </g>
...
function ReviewsIllustration() {
    return (<svg viewBox="0 0 180 160" className="size-full">
      <circle cx="90" cy="82" r="60" fill="#eef1f6"/>
      <rect x="46" y="20" width="96" height="88" rx="14" fill="white" stroke="#cfd6e2" strokeWidth="2" transform="rotate(6 94 64)"/>
      <rect x="30" y="30" width="112" height="92" rx="16" fill="white" stroke="#0f7a75" strokeWidth="2.5"/>
      <clipPath id="hiw-avatar-clip">
        <circle cx="58" cy="60" r="17"/>
      </clipPath>
      <circle cx="58" cy="60" r="18" fill="#cfe9e6"/>
      <image href={avatar3.src} x="41" y="43" width="34" height="34" clipPath="url(#hiw-avatar-clip)" preserveAspectRatio="xMidYMid slice"/>
      <rect x="84" y="50" width="46" height="7" rx="3.5" fill="#e2e8f0"/>
      <rect x="84" y="64" width="32" height="7" rx="3.5" fill="#e2e8f0"/>
      {Array.from({ length: 5 }, (_, i) => (<path key={i} d="M0 -6 1.5 -2 6 -2 2.5 0.8 4 5 0 2.3 -4 5 -2.5 0.8 -6 -2 -1.5 -2Z" fill="#ffc400" transform={`translate(${44 + i * 14} 90)`}/>))}
      <circle cx="122" cy="100" r="13" fill="#0f7a75"/>
      <path d="M116.5 100l4 4 7-8" fill="none" stroke="white" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>);
}
function DoorIllustration() {
    return (<svg viewBox="0 0 160 170" className="size-full">
      <circle cx="80" cy="86" r="60" fill="#eef1f6"/>
      <rect x="26" y="128" width="108" height="8" fill="#e3e8ee"/>
      <path d="M46 132V70c0-18 14-32 34-32s34 14 34 32v62" fill="#f4f0e6" stroke="#0f7a75" strokeWidth="2.5"/>
      <path d="M80 132V50c14 2 24 12 24 22v60" fill="none" stroke="#0f7a75" strokeWidth="1.5" strokeOpacity="0.5"/>
      <circle cx="72" cy="98" r="2.4" fill="#0f7a75"/>
      <path d="M110 60c8-2 12 2 12 8s-6 8-6 8" fill="none" stroke="#c9b79a" strokeWidth="2" strokeLinecap="round"/>
      <rect x="112" y="70" width="10" height="12" rx="2" fill="#ffc400"/>
      <path d="M117 70v-6" stroke="#c9b79a" strokeWidth="2" strokeLinecap="round"/>
      <path d="M28 132c2-16 10-24 16-24s6 8 12 8 6-6 10-6" fill="none" stroke="#a9d6c6" strokeWidth="2" strokeLinecap="round"/>
      <path d="M22 132c0-14 6-22 10-22s5 8 9 8" fill="#a9d6c6"/>
      <rect x="18" y="120" width="14" height="16" rx="2" fill="#c9b79a"/>
      <path d="M122 101l20 8v16c0 13-9 22-20 27-11-5-20-14-20-27v-16l20-8Z" fill="#0f7a75" stroke="white" strokeWidth="3"/>
      <path d="M112 124l7 7 13-14" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>);
}
    ...
    return (<section id="comment-ca-marche" className="relative isolate scroll-mt-20 overflow-hidden bg-[#f6f5fc] py-20 sm:py-24 lg:scroll-mt-24 lg:py-[86px]">
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="relative mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 lg:mt-10 lg:grid-cols-3 lg:gap-10">
          {steps.map((step, index) => (<div key={step.number} className={`relative min-h-110 rounded-[15px] bg-white px-5 pb-7 pt-5 text-center shadow-[0_12px_34px_rgba(69,64,112,0.055)] sm:px-6 lg:px-7 ${index === steps.length - 1
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-[15px] text-slate-600">
                Carte d&apos;identité, selfie et statut légal vérifiés sous
                48h : vous savez à qui vous faites confiance.
              </p>
            </div>
          </div>
          <Link href="/verification" className="flex shrink-0 items-center gap-3 pl-15 text-[16px] font-bold text-teal-700 transition-colors hover:text-teal-800 sm:pl-0">
