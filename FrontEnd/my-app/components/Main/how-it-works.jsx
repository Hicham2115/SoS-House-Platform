...
const steps = [
  {
    ...
    description:
      "Décrivez votre besoin en quelques secondes : le type de service, votre adresse, l'urgence et si vous avez besoin d'une facture, simple ou avec TVA.",
  ...
  },
  {
    ...
    description:
      "Votre demande est envoyée aux prestataires vérifiés éligibles les plus proches et les mieux notés. Recevez leurs propositions, avec avis liés à des travaux réalisés.",
  ...
  },
  {
    ...
    description:
      "Sélectionnez l'artisan qui vous convient. Une fois la mission terminée, vous confirmez chacun de votre côté avant que les avis ne soient publiés.",
  ...
  return (
    <svg viewBox="0 0 160 160" className="size-full">
      ...
      <g>
        ...
        <rect x="58" y="122" width="44" height="12" rx="6" fill="#ffa514" />
      </g>
    </svg>
  );
}
function ReviewsIllustration() {
  return (
    <svg viewBox="0 0 180 160" className="size-full">
      ...
      <circle cx="58" cy="60" r="18" fill="#cfe0e9" />
      <image
        href={avatar3.src}
        x="41"
        y="43"
      ...
      <circle cx="122" cy="100" r="13" fill="#0f557a" />
      <path
  ...
  return (
    <svg viewBox="0 0 160 170" className="size-full">
      ...
      <path
        ...
        strokeOpacity="0.5"
      />
      <circle cx="72" cy="98" r="2.4" fill="#0f557a" />
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="112" y="70" width="10" height="12" rx="2" fill="#ffa514" />
      <path
        d="M117 70v-6"
        stroke="#c9b79a"
        strokeWidth="2"
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M22 132c0-14 6-22 10-22s5 8 9 8" fill="#a9c6d6" />
...
export function HowItWorks() {
  return (
    <section
      ...
      className="relative isolate scroll-mt-20 overflow-hidden bg-[#f6f5fc] py-20 sm:py-24 lg:scroll-mt-24 lg:py-[86px]"
    >
      <ZelligeCorner
        id="zellige-tr"
        corner="top-right"
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-9 flex flex-col gap-5 rounded-[20px] bg-teal-800 px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-10">
          <div className="flex items-start gap-4">
            <span className="flex size-14 shrink-0 items-center justify-center border-r border-[#c8c5e0] pr-4 text-white sm:size-auto sm:pr-7">
            ...
            <div>
              ...
              <p className="mt-1 text-[15px] text-white">
                Carte d&apos;identité, selfie et statut légal vérifiés sous 48h
          ...
          <Link
            href="/verification"
            className="flex shrink-0 items-center gap-3 pl-15 text-[16px] font-bold text-white transition-colors hover:text-white/70 sm:pl-0"
          >
