...
const previewCardClass =
  "relative rounded-2xl bg-white p-4 shadow-[0_12px_34px_rgba(69,64,112,0.08)]";
...
function IdentityPreview() {
  return (
    <div className={`${previewCardClass} flex items-center gap-3`}>
      <Image
        src={avatar2}
        alt=""
...
const providerLevels = [
  {
    ...
    Icon: Wrench,
    description:
      "Identité vérifiée, sans facture. Le profil le plus courant du marché pour les travaux du quotidien.",
  },
  {
    code: "N1",
    ...
    Icon: Briefcase,
    description:
      "Facture simple fournie, sans TVA récupérable. Un statut légal vérifié pour plus de sérénité.",
  },
  {
    code: "N2",
    ...
    Icon: Building2,
    description:
      "ICE vérifié, facture avec TVA récupérable. Le bon choix pour entreprises, hôtels et professionnels.",
  },
];
const pillars = [
  {
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="relative mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 lg:mt-10 lg:grid-cols-3 lg:gap-10">
          {pillars.map((pillar, index) => (
            <div
              key={pillar.title}
              className={`rounded-[20px] bg-[#ecebf9] p-6 sm:p-7 ${
