...
export default function NotFound() {
  return (
    <section className="relative flex flex-1 items-center overflow-hidden bg-[#f4f3fb] px-4 py-20 sm:px-8">
      <ZelligeCorner
        id="not-found-zellige-tr"
        corner="top-right"
        className="pointer-events-none absolute -right-20 -top-20 h-80 w-80 opacity-70 sm:h-110 sm:w-110"
      />
      <ZelligeCorner
        id="not-found-zellige-bl"
        corner="bottom-left"
        className="pointer-events-none absolute -bottom-20 -left-20 h-80 w-80 opacity-70 sm:h-110 sm:w-110"
      />
